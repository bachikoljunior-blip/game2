...
surfaces=json.loads((R/'surfaces.json').read_text())
...
render('shrine-shape',lambda n:n.startswith('scene-art-') and n not in ['scene-art-rock','scene-art-paving'],[13,10,-5],[0,3.1,-23],60)
render('paving-shape',lambda n:n=='scene-art-paving',[2,5,24],[0,0,17],190)
