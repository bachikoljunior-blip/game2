...
export const SHOTS = {
   ...
   *
   * The sun is ESE at 13° elevation, direction (0.86, 0.225, 0.457). The first version
   * of this pose aimed dead centre and put the disc *inside the gakuzuka's silhouette* —
   * measured luminance 7.1 at the sun's own pixel, so the source was extinguished and no
   * gain could produce a shaft. Crepuscular rays need the occluder beside the disc, not
   * on it. This stands 6 m short of the gate and 1.2 m off the axis, so the disc sits in
   * the open bay at ~3.2 m with the upright, the nuki and the shimenawa crossing the fan.
   */
  sun: { pos: [-3.96, 1.8, 35.76], target: [47.64, 15.3, 63.16], fov: 52 },
